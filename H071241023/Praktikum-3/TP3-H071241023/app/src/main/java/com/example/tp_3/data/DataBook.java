...
public class DataBook {
    ...
    public static void initData() {
        ...
        listBook.add(new Book(
                ...
                "Uketsu",
                "2026",
                "Gambar yang dibuat seorang wanita hamil di internet...\n" +
                        "Gambar yang dibuat seorang anak kecil sebagai hadiah Hari Ibu...\n" +
                        "Gambar yang dibuat seorang korban pembunuhan di saat-saat terakhirnya...\n" +
                        "\n" +
                        "Jika dilihat sekilas, gambar-gambar ini terkesan biasa saja. Namun, jika dicermati lebih dalam, di sana-sini terdapat keganjilan... keganjilan yang akhirnya mendorong seorang detektif amatir menyusuri labirin penuh teka-teki yang mengarah pada sebuah kenyataan mengerikan.\n" +
                        "\n" +
                        "Novel kedua dari YouTuber populer, Uketsu—sosok misterius bertopeng yang merupakan salah satu penulis kontemporer paling populer di Jepang.",
                R.drawable.gambar_aneh));
        listBook.add(new Book(
                "Salvation of a Saint",
                "Keigo Higashino",
                "2021",
                "Salvation of a Saint kisahkan kasus seorang lelaki yang ditemukan tewas di rumahnya akibat kopi beracun. Istrinya menjadi satu-satunya tersangka yang paling kuat, karena ia telah dicampakkan sang suami belakangan ini.\n" +
                        "Masalahnya, pada hari pembunuhan terjadi wanita itu berada ribuan kilometer dari tempat kejadian. Berbagai opini yang bertentangan dilontarkan oleh Detektif Kusanagi dan Detektif Utsumi Kaoru saat penyelidikan.\n" +
                        "Detektif Utsumi merasa jika Detektif Kusanagi terlalu berempati terhadap istri korban yang telah melarikan diri itu. Oleh karenanya, Detektif Utsumi segera bertindak dan meminta bantuan Profesor Manabu Yukawa untuk meluruskan logika Detektif Kusanagi, sekaligus membantunya pada saat mereka berada di kepolisian.\n" +
                        "Namun ternyata, sosok ilmuan jenius yang dijuluki sebagai Detektif Galileo itu kebingungan juga, karena tidak mungkin seseorang memasukan racun kopi dari jarak sejauh itu. Di sinilah kecerdasan sang profesor diuji, ia harus menguak trik bagaimana racun itu muncul di waktu yang tepat, tempat yang sempurn, dan tidak salah sasaran.",
                R.drawable.salvation));
        listBook.add(new Book(
                "Malice",
                "Keigo Higashino",
                "2020",
        ...
        listBook.add(new Book(
                ...
                "Minato Kanae",
                "2019",
                "“Sebuah thriller psikologi yang efektif dan meremangkan bulu kuduk … Pembaca pasti akan dibuat terkejut lebih dari sekali… Tersirat, tanpa jeda, menakjubkan.”\n" +
                        "― Tom Nolan, Wall Street Journal\n" +
                        "\n" +
                        "“Novel yang tidak akan bisa kau letakkan ini gelap, meresahkan, dan menipu.”\n" +
        ...
        listBook.add(new Book(
                ...
                R.drawable.toko_kelontong));
        listBook.add(new Book("Bulan",
                "Tere Liye",
                "2015",
        ...
        listBook.add(new Book(
                ...
                "Gege Akutami",
                "2024",
                "Jujutsu Kaisen Volume 26 berfokus pada puncak pertarungan antara dua penyihir terkuat, Gojo Satoru dan Ryomen Sukuna. Volume ini menonjolkan bentrokan dahsyat di mana keduanya mengerahkan teknik terkutuk dan wilayah (Domain Expansion) mereka hingga batas maksimal.",
                R.drawable.jjk));
        listBook.add(new Book(
                "Shingeki no Kyojin Vol.34",
                "Hajime Isayama",
                "2021",
                "Attack on Titan Volume 34 (chapter 135-139) adalah volume penutup epik, menampilkan pertempuran akhir melawan Eren Yeager dan Founding Titan. Aliansi (Mikasa, Levi, Armin, dll.) berjuang menghentikan Rumbling. Volume ini menyajikan penyelesaian konflik, akhir kisah Eren, dan nasib dunia, serta halaman tambahan yang mengungkap masa depan Paradis. ",
                R.drawable.aot));
    }
}
